          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="dark:bg-gray-600 block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                value={searchTerm}
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 rounded-lg">
                <thead className="bg-gray-50 dark:bg-gray-700 dark:border-gray-100 dark:text-gray-100 dark:border-b rounded-lg">
                  <tr>
                    <th
                      scope="col"
                    ...
                    >
                        ...
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <img
                              ...
                              src={
                                character.image || "/placeholder-character.jpg"
                              }
                              alt={character.name}
                            />
                          </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button
                          ...
                          className="text-indigo-600 hover:text-indigo-900 mr-4 dark:text-indigo-400 dark:hover:text-indigo-600"
                        >
                          Sửa
                        </button>
                        <button
